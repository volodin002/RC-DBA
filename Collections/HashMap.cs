...
namespace RC.DBA.Collections
{
    public class HashMap<TKey, TValue> 
    {
        ...
        public IEnumerable<TValue> Values => new ValueEnumerable(_array, _count);
        ...
        {
            if (_count == 0)
                return new HashMap<TKey, TValue>(null, _empty, 0);
        ...
        protected struct ValueEnumerator : IEnumerator<TValue>
        {
            private Slot[] _array;
            private int _index;
            private int _count;
