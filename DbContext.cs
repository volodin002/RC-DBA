...
namespace RC.DBA
{
    public class DbContext
    {
        ...
        {
            return GetValue<T>(con, sql, (IEnumerable<Parameter>)parameters);
        }

        public List<T> GetValueList<T>(DbConnection con, string sql, params Parameter[] parameters) 
        {
            return GetValueList<T>(con, sql, (IEnumerable<Parameter>)parameters);
        }
        ...
        {
            return GetValue<T>(con, sql, tran, (IEnumerable<Parameter>)parameters);
        }

        public List<T> GetValueList<T>(DbConnection con, string sql, DbTransaction tran, params Parameter[] parameters) 
        {
            return GetValueList<T>(con, sql, tran, (IEnumerable<Parameter>)parameters);
        }
