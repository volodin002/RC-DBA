    ...
    class EntityAttribute : IEntityAttribute
    {
        ...
        public EntityAttribute(MemberInfo member, IEntityType entityType)
        {
            ...
            if (!IsAssociation)
            {
                ...
                IsAssociation = notNullabeType != typeof(Guid) && Type.GetTypeCode(notNullabeType) == TypeCode.Object;
            }
        ...
        public IEntityAttribute GetCollectionForeignKey()
        {
            ...
            if (inversePropAttr != null)
            {
                ...
                return foreignKeyEntity.GetAttribute(name).ForeignKey;
            }
            else
            {
                ...
                return foreignKeyEntity.GetAttribute(name);
            }
